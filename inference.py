"""Run inference on the SciQ test set and save the results to a TSV file."""

import os
import random

from datasets import load_dataset
from utils import do_inference, format_row_no_answer, format_row_with_answer, load_model_for_inference, parse_output
...
def main() -> None:
    ...
    random_test_samples = dataset["test"].select(random.sample(range(len(dataset["test"])), 120))
